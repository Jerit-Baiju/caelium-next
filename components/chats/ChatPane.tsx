          ...
          <Link key={id} href={`/chats/${id}`}>
            <li className='py-3 sm:py-4'>
              <div className='flex items-center space-x-3 rtl:space-x-reverse'>
                ...
                <span className='inline-flex items-center bg-green-100 text-green-700 text-xs font-medium px-2 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300'>
