...
const SideBar: React.FC<{ chats: Chat[] }> = ({ chats }) => {
  return (
    <div className='flex flex-col md:flex-row flex-grow dark:text-white'>
      <div className='md:w-1/5 flex-grow-0 md:pr-4 md:border-r-2 border-gray-200 dark:border-gray-700'>
