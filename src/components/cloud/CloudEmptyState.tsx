...
const CloudEmptyState = ({ currentPath }: CloudEmptyStateProps) => {
  // Build the upload URL with the current directory as a query parameter
  const uploadUrl = currentPath ? `/cloud/upload?dir=${encodeURIComponent(currentPath)}` : '/cloud/upload';
