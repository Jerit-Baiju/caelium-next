    ...
    <motion.div
      ...
      <div className="relative aspect-square">
        <img 
          ...
          onClick={() => handleLike()} // Double click to like
        />
      ...
      <div className="p-3">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            <button 
              onClick={handleLike} 
              className={`${liked ? 'text-red-500' : 'text-neutral-600 dark:text-neutral-400'}`}
            >
        ...
        {post.comments > 0 && (
          <button className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
